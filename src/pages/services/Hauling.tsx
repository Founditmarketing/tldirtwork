    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex flex-col font-sans relative overflow-hidden">
      ...
      <section className="relative w-full flex flex-col justify-end min-h-[50vh] lg:min-h-[auto] pt-32 lg:pt-[208px] pb-16 lg:pb-0 overflow-hidden lg:overflow-visible">
        ...
        <div className="absolute inset-0 w-full h-full lg:hidden block z-0 bg-[#0a0a0a]">
          <img src="/t&lhauling.jpeg" alt="T & L Hauling" className="w-full h-full object-cover opacity-60 mix-blend-luminosity" />
        ...
        <div className="max-w-[1400px] mx-auto w-full px-4 lg:px-8 relative z-10 flex flex-col">
          ...
          >
            ...
            <h1 className="font-heading font-black text-5xl md:text-7xl lg:text-8xl tracking-tighter uppercase leading-[0.9] drop-shadow-2xl">
              HEAVY <span className="text-bronze">HAULING</span>
            </h1>
          </motion.div>
        </div>
      </section>
          ...
          <div className="w-full max-w-[750px] px-4 lg:px-10 xl:px-14 relative z-10">
            ...
            >
              ...
              <p className="text-black/70 font-light text-base md:text-lg mb-6 leading-relaxed">
                Material transport is the lifeblood of massive site operations. At T & L Dirtwork, Inc., we maintain an impressive logistical fleet of heavy-duty trucks and articulated trailers designed to efficiently transport massive loads across all types of challenging regional terrain.
              </p>
              
              <p className="text-black/70 font-light text-base md:text-lg mb-8 leading-relaxed">
                We handle the delivery and removal of heavy dirt, large construction components, and specialized site prep equipment. Our hauling crews seamlessly integrate with our excavation teams, guaranteeing that your operation never experiences downtime due to missing materials.
              </p>

              <div className="flex flex-col sm:flex-row gap-4 mt-4">
                <div className="flex items-center">
                   <CheckCircle2 size={20} className="text-bronze mr-3" />
                   <span className="font-bold tracking-widest uppercase text-[10px]">Large Logistical Fleet</span>
                </div>
                <div className="flex items-center">
                   <CheckCircle2 size={20} className="text-bronze mr-3" />
                   <span className="font-bold tracking-widest uppercase text-[10px]">Heavy Material Solutions</span>
                </div>
              </div>
            </motion.div>
          </div>
