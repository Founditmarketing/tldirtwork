          ...
          >
            <div className="relative inline-flex flex-col items-center justify-center px-6 md:px-16 pb-6 md:pb-8 pt-2">
              <motion.div 
                ...
                className="font-heading font-black text-xl sm:text-2xl md:text-5xl tracking-[0.15em] md:tracking-[0.2em] text-white uppercase text-center whitespace-nowrap"
              >
                T & L DIRTWORK<span className="text-bronze">, INC.</span>
              </motion.div>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-black/95 backdrop-blur-md border-b-[0.5px] border-bronze/30 shadow-2xl' : 'bg-transparent border-b-[0.5px] border-bronze/20'}`}>
        ...
        <div className={`hidden sm:flex items-center px-8 transition-all duration-300 overflow-hidden text-[10px] tracking-widest text-bronze uppercase border-b border-bronze/20 ${isScrolled ? 'h-0 opacity-0 overflow-hidden border-transparent opacity-0 pointer-events-none' : 'h-[34px] py-2 opacity-100'}`}>
          <div className="flex items-center w-full">
            {['T & L DIRTWORK', 'SERVICES', 'PROJECTS', 'CONTACT'].map((item, idx) => (
              <React.Fragment key={item}>
                <a href="#" className={`px-4 hover:text-white transition-colors ${idx === 0 ? 'pl-0 font-bold' : 'text-white/50'}`}>
                  {item}
                </a>
                {idx < 3 && <span className="h-4 w-[1px] bg-bronze/40"></span>}
              </React.Fragment>
            ))}
        ...
        <div className="flex items-center justify-between px-4 lg:px-8 py-4">
          <div className="flex items-center gap-4 lg:gap-8">
            {/* Logo Area */}
            <div className="font-heading font-black text-xl lg:text-2xl tracking-tighter flex items-center">
              T & L DIRTWORK<span className="text-bronze ml-1">, INC.</span>
            ...
            <nav className="hidden lg:flex items-center gap-6 text-[11px] font-bold tracking-widest uppercase">
              {['REQUEST A QUOTE', 'OUR SERVICES', 'ABOUT US', 'PROJECTS'].map((item, idx) => (
                <React.Fragment key={item}>
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex items-center justify-between mb-12">
                <div className="font-heading font-black text-2xl tracking-tighter flex items-center text-white">
                  T & L DIRTWORK<span className="text-bronze ml-1">, INC.</span>
                </div>
                <button 
              ...
              <nav className="flex flex-col gap-6 text-left mb-16 w-full mt-4">
                {['REQUEST A QUOTE', 'SERVICES', 'PROJECTS', 'ABOUT US', 'CONTACT'].map((item) => (
                  <a 
                    key={item} 
                    href="#" 
                    onClick={() => setIsMobileMenuOpen(false)}
      ...
      <section className="bg-black text-white py-8 lg:py-12 relative overflow-hidden border-t-[0.5px] border-white/10">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-stretch w-full py-8 lg:py-12 overflow-hidden">
          ...
          <div className="flex flex-col justify-center gap-6 relative w-full lg:w-1/2 items-center lg:items-end py-8">
             <div className="w-[90%] sm:w-[80%] lg:w-[85%] px-8 py-8 lg:px-12 flex flex-row items-center justify-between text-left bg-bronze/60 backdrop-blur-md shadow-[0_15px_50px_rgba(0,0,0,0.6)] rounded-none relative overflow-hidden group transition-all duration-700 hover:-translate-x-6 hover:bg-bronze hover:shadow-[0_20px_60px_rgba(167,54,2,0.5)] border-none">
                <span className="font-heading font-black text-5xl lg:text-6xl tracking-tighter text-white relative z-10 drop-shadow-md transition-transform duration-500 group-hover:scale-105">
                   <AnimatedCounter from={0} to={245} duration={2} />
                </span>
                <span className="font-bold tracking-widest uppercase text-xs lg:text-sm text-white/90 relative z-10 ml-6 text-right drop-shadow-sm transition-transform duration-500 group-hover:translate-x-2">Satisfied<br/>Clients</span>
             </div>
             
             <div className="w-[90%] sm:w-[80%] lg:w-[98%] px-8 py-8 lg:px-12 flex flex-row items-center justify-between text-left bg-bronze/60 backdrop-blur-md shadow-[0_15px_50px_rgba(0,0,0,0.6)] rounded-none relative overflow-hidden group transition-all duration-700 hover:-translate-x-6 hover:bg-bronze hover:shadow-[0_20px_60px_rgba(167,54,2,0.5)] border-none">
                <span className="font-heading font-black text-5xl lg:text-6xl tracking-tighter text-white relative z-10 drop-shadow-md transition-transform duration-500 group-hover:scale-105">
                   <AnimatedCounter from={0} to={2000} duration={2.5} suffix="+" />
                </span>
                <span className="font-bold tracking-widest uppercase text-xs lg:text-sm text-white/90 relative z-10 ml-6 text-right drop-shadow-sm transition-transform duration-500 group-hover:translate-x-2">Projects<br/>Completed</span>
             </div>
             
             <div className="w-[90%] sm:w-[80%] lg:w-[75%] px-8 py-8 lg:px-12 flex flex-row items-center justify-between text-left bg-bronze/60 backdrop-blur-md shadow-[0_15px_50px_rgba(0,0,0,0.6)] rounded-none relative overflow-hidden group transition-all duration-700 hover:-translate-x-6 hover:bg-bronze hover:shadow-[0_20px_60px_rgba(167,54,2,0.5)] border-none">
                <span className="font-heading font-black text-5xl lg:text-6xl tracking-tighter text-white relative z-10 drop-shadow-md transition-transform duration-500 group-hover:scale-105">
                   <AnimatedCounter from={0} to={24} duration={1.5} />
                </span>
                <span className="font-bold tracking-widest uppercase text-xs lg:text-sm text-white/90 relative z-10 ml-6 text-right drop-shadow-sm transition-transform duration-500 group-hover:translate-x-2">Years<br/>Experience</span>
             </div>
          </div>
